---
description: Generate a git message
---

Automatically stage the modified files (git add .), but do not commit.  Write a consolidated git commit message for the changes made to the modified files.
